      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-gray-900 flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-mint border-2 border-white dark:border-gray-900" />
              </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full flex justify-center">
              <div className="w-full max-w-md ml-24">
                <h3 className="md:hidden block text-2xl mb-4 text-center font-bold text-gray-500 dark:text-gray-400">
                  {item.title}
                </h3>
                {item.content}
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-mint via-navy to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
