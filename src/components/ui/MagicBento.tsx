...
const DEFAULT_GLOW_COLOR = '127, 255, 212';
...
const cardData = [
  {
    ...
    label: 'Development',
    gridClass: 'grid-column-2 grid-row-2' // Large card
  },
  {
    color: '#2B2B2B',
    title: 'UI/UX Design',
    ...
    label: 'Design',
    gridClass: 'grid-column-1 grid-row-1' // Small card
  },
  {
    color: '#2B2B2B',
  ...
  },
  {
    ...
    label: 'E-commerce',
    gridClass: 'grid-column-1 grid-row-2' // Medium card
  },
  {
    color: '#2B2B2B',
    ...
    label: 'Mobile',
    gridClass: 'grid-column-2 grid-row-1' // Medium card
  },
  {
    color: '#2B2B2B',
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          const baseClassName = `card card-container ${card.gridClass} ${textAutoHide ? 'card--text-autohide' : ''} ${enableBorderGlow ? 'card--border-glow' : ''}`;
          const cardProps = {
